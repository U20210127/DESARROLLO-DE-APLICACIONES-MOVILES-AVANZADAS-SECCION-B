...
object Configuraciones {
    ...
    private const val URL_DISPOSITIVO = "http://192.168.1.7/api_agenda/controllers/api_contactos.php"
    ...
    const val URL_WEBSERVICES = "http://192.168.1.7/api_agenda/controllers/api_contactos.php"
}